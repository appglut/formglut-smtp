...
namespace FormglutMail\App\Services\Mailer\Providers\Mailgun;
...
class Handler extends BaseHandler
{
    ...
    public function postSend()
    {
        ...
        $body = [
            ...
            'h:X-Mailer'     => 'FormglutMail - Mailgun',
    ...
    public function setSettings($settings)
    {
        if ($settings['key_store'] == 'wp_config') {
            $settings['api_key'] = defined('FORMGLUTMAIL_MAILGUN_API_KEY') ? FORMGLUTMAIL_MAILGUN_API_KEY : '';
            $settings['domain_name'] = defined('FORMGLUTMAIL_MAILGUN_DOMAIN') ? FORMGLUTMAIL_MAILGUN_DOMAIN : '';
        }
