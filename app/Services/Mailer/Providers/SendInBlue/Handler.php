...
use FormglutMail\App\Services\Mailer\Providers\SendInBlue\ValidatorTrait;
...
class Handler extends BaseHandler
{
    ...
    public function setSettings($settings)
    {
        if($settings['key_store'] == 'wp_config') {
            $settings['api_key'] = defined('FORMGLUTMAIL_SENDINBLUE_API_KEY') ? FORMGLUTMAIL_SENDINBLUE_API_KEY : '';
        }
