...
namespace FormglutMail\App\Services\Mailer\Providers\SendInBlue;
...
trait ValidatorTrait
{
    ...
    public function validateProviderInformation($connection)
    {
        ...
        if($keyStoreType == 'db') {
            ...
            if(!defined('FORMGLUTMAIL_SENDINBLUE_API_KEY') || !FORMGLUTMAIL_SENDINBLUE_API_KEY) {
                $errors['api_key']['required'] = __('Please define FORMGLUTMAIL_SENDINBLUE_API_KEY in wp-config.php file.', 'formglut-smtp');
            }
        }
