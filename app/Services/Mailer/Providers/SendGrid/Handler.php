...
use FormglutMail\App\Services\Mailer\Providers\SendGrid\ValidatorTrait;
...
class Handler extends BaseHandler
{
    ...
    public function setSettings($settings)
    {
        if($settings['key_store'] == 'wp_config') {
            $settings['api_key'] = defined('FORMGLUTMAIL_SENDGRID_API_KEY') ? FORMGLUTMAIL_SENDGRID_API_KEY : '';
        }
