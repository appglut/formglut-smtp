...
namespace FormglutMail\App\Services\Mailer\Providers\SendGrid;
...
trait ValidatorTrait
{
    ...
    public function validateProviderInformation($connection)
    {
        ...
        if($keyStoreType == 'db') {
            ...
            if(!defined('FORMGLUTMAIL_SENDGRID_API_KEY') || !FORMGLUTMAIL_SENDGRID_API_KEY) {
                $errors['api_key']['required'] = __('Please define FORMGLUTMAIL_SENDGRID_API_KEY in wp-config.php file.', 'formglut-smtp');
            }
        }
