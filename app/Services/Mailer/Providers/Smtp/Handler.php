...
use FormglutMail\App\Services\Mailer\Providers\Smtp\ValidatorTrait;
...
class Handler extends BaseHandler
{
    ...
    protected function postSend()
    {
        try {
            ...
            if ($this->isForcedEmail() && !formglutMailIsListedSenderEmail($fromEmail)) {
    ...
    public function setSettings($settings)
    {
        if (Arr::get($settings, 'key_store') == 'wp_config') {
            $settings['username'] = defined('FORMGLUTMAIL_SMTP_USERNAME') ? FORMGLUTMAIL_SMTP_USERNAME : '';
            $settings['password'] = defined('FORMGLUTMAIL_SMTP_PASSWORD') ? FORMGLUTMAIL_SMTP_PASSWORD : '';
        }
