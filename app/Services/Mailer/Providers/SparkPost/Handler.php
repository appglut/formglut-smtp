...
use FormglutMail\App\Services\Mailer\Providers\SparkPost\ValidatorTrait;
...
class Handler extends BaseHandler
{
    ...
    public function postSend()
    {
        $body = [
            'options' => [
                'sandbox' => defined('FORMGLUTMAIL_TEST_EMAIL')
            ],
            'content' => [
                'from' => $this->getFrom(),
    ...
    public function setSettings($settings)
    {
        if($settings['key_store'] == 'wp_config') {
            $settings['api_key'] = defined('FORMGLUTMAIL_SPARKPOST_API_KEY') ? FORMGLUTMAIL_SPARKPOST_API_KEY : '';
        }
    ...
    {
        return [
            'X-Mailer' => 'FormglutMail - SparkPost'
        ];
    }
