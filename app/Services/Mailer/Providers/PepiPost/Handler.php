...
use FormglutMail\App\Services\Mailer\Providers\PepiPost\ValidatorTrait;
...
class Handler extends BaseHandler
{
    ...
    public function setSettings($settings)
    {
        if($settings['key_store'] == 'wp_config') {
            $settings['api_key'] = defined('FORMGLUTMAIL_PEPIPOST_API_KEY') ? FORMGLUTMAIL_PEPIPOST_API_KEY : '';
        }
