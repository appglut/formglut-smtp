...
class Handler extends BaseHandler
{
    ...
    public function postSend()
    {
        ...
        $ses = formglutMailSesConnection($connectionSettings);
    ...
    public function getValidSendingIdentities($config)
    {
        ...
        if (apply_filters('formglut_mail_ses_primary_domain_only', true)) {
        ...
        return [
            'emails'          => apply_filters('formglutsmtp_ses_valid_senders', $addresses, $config),
    ...
    public function getConnectionInfo($connection)
    {
        ...
        $info = (string)formglutMail('view')->make('admin.ses_connection_info', [
    ...
    public function addNewSenderEmail($connection, $email)
    {
        ...
        update_option('formglutmail-settings', $settings);
    ...
    private function filterConnectionVars($connection)
    {
        if ($connection['key_store'] == 'wp_config') {
            $connection['access_key'] = defined('FORMGLUTMAIL_AWS_ACCESS_KEY_ID') ? FORMGLUTMAIL_AWS_ACCESS_KEY_ID : '';
            $connection['secret_key'] = defined('FORMGLUTMAIL_AWS_SECRET_ACCESS_KEY') ? FORMGLUTMAIL_AWS_SECRET_ACCESS_KEY : '';
        }
