...
namespace FormglutMail\App\Services\Mailer\Providers\ElasticMail;
...
class Handler extends BaseHandler
{
    ...
    public function setSettings($settings)
    {
        if ($settings['key_store'] == 'wp_config') {
            $settings['api_key'] = defined('FORMGLUTMAIL_ELASTICMAIL_API_KEY') ? FORMGLUTMAIL_ELASTICMAIL_API_KEY : '';
        }
