...
namespace FormglutMail\App\Services;
...
class NotificationHelper
{
    ...
    {
        if (defined('FORMGLUTSMTP_SERVER_REMOTE_SERVER_URL')) {
            return FORMGLUTSMTP_SERVER_REMOTE_SERVER_URL;
        }

        return 'https://formglutsmtp.com/wp-json/formglutsmtp_notify/v1/';
    }
        ...
        return [
            ...
            'blocks' => [
                ...
                [
                    ...
                    'text' => [
                        'type' => "mrkdwn",
                        'text' => "<" . admin_url('admin.php?page=formglut_forms_smtp/logs?per_page=10&page=1&status=failed&search=') . "|View Failed Email(s)>"
                    ]
                ]
            ]
        ];
    ...
    public static function formatDiscordMessageBlock($handler, $logData = [])
    {
        ...
        $content .= '[View Failed Email(s)](' . admin_url('admin.php?page=formglut_forms_smtp/logs?per_page=10&page=1&status=failed&search=') . ')';
