<?php namespace FormglutMail\App\Services\DB\QueryBuilder\Adapters;

use FormglutMail\App\Services\DB\Connection;
use FormglutMail\App\Services\DB\Exception;
use FormglutMail\App\Services\DB\QueryBuilder\Raw;

abstract class BaseAdapter
{
    /**
     * @var \FormglutMail\App\Services\DB\Connection
     */
     ...
     *
     * @return array
     * @throws \FormglutMail\App\Services\DB\src\Exception
     */
        ...
        foreach ($statements as $statement) {
            ...
            if (is_null($value) && $key instanceof \Closure) {
                ...
                $nestedCriteria = $this->container->build(
                    '\\FormglutMail\\App\\Services\\DB\\QueryBuilder\\NestedCriteria',
