<?php namespace FormglutMail\App\Services\DB\QueryBuilder;

use FormglutMail\App\Services\DB\Connection;
use FormglutMail\App\Services\DB\Exception;

class QueryBuilderHandler
{

    /**
     * @var \FormglutMail\App\Services\DB\Viocon\Container
     */
    protected $container;

    /**
     * @var \FormglutMail\App\Services\DB\src\Connection
     */
    ...
    /**
     * @var \FormglutMail\App\Services\DB\QueryBuilder\Adapters\BaseAdapter
     */
    ...
    /**
     * @param null|\FormglutMail\App\Services\DB\Connection $connection
     *
     * @throws \FormglutMail\App\Services\DB\Exception
     */
    public function __construct(Connection $connection = null)
    {
        ...
        $this->adapterInstance = $this->container->build(
            '\\FormglutMail\\App\\Services\\DB\\QueryBuilder\\Adapters\\' . ucfirst($this->adapter),
    ...
    public function query($sql, $bindings = array())
    {
        $this->dbStatement = $this->container->build(
            '\\FormglutMail\\App\\Services\\DB\\QueryBuilder\\QueryObject',
            array($sql, $bindings)
        )->getRawSql();
    ...
    public function join($table, $key, $operator = null, $value = null, $type = 'inner')
    {
        ...
        $joinBuilder = $this->container->build('\\FormglutMail\\App\\Services\\DB\\QueryBuilder\\JoinBuilder', array($this->connection));
    ...
    public function transaction(\Closure $callback)
    {
        try {
            ...
            $transaction = $this->container->build(
                '\\FormglutMail\\App\\Services\\DB\\QueryBuilder\\Transaction',
                array($this->connection)
            );
    ...
    {
        return $this->container->build('\\FormglutMail\\App\\Services\\DB\\QueryBuilder\\Raw', array($value, $bindings));
    }
    ...
    /**
     * @param \FormglutMail\App\Services\DB\Connection $connection
     *
     * @return $this
     */
    ...
    /**
     * @return \FormglutMail\App\Services\DB\Connection
     */
