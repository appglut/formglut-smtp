<?php
namespace FormglutMail\App\Services\DB;

use FormglutMail\App\Services\DB\Viocon\Container;
...
class Connection
{
    ...
    public function __construct($wpdb, array $config = array(), $alias = null, Container $container = null)
    {
        ...
        $this->eventHandler = $this->container->build('\\FormglutMail\\App\\Services\\DB\\EventHandler');
    ...
    {
        class_alias('FormglutMail\\App\\Services\\DB\\AliasFacade', $alias);

        $builder = $this->container->build('\\FormglutMail\\App\\Services\\DB\\QueryBuilder\\QueryBuilderHandler', array($this));
    ...
    {
        return $this->container->build('\\FormglutMail\\App\\Services\\DB\\QueryBuilder\\QueryBuilderHandler', array($this));
    }
    ...
    /**
     * @return \FormglutMail\App\Services\DB\Viocon\Container
     */
