...
namespace FormglutMail\App\Models;

use FormglutMail\Includes\Support\Arr;
use FormglutMail\App\Services\Mailer\Manager;
use FormglutMail\App\Models\Traits\SendTestEmailTrait;

class Settings
{
    use SendTestEmailTrait;

    protected $optionName = FORMGLUTMAIL . '-settings';

    public function get()
    {
        return formglutMailGetSettings();
    }
    ...
    public function store($inputs)
    {
        ...
        $providers = formglutMail(Manager::class)->getConfig('providers');
        ...
        formglutMailSetSettings($settings);
    ...
    {
        return formglutMailSetSettings($data);
    }
    ...
    {
        $optionName = FORMGLUTMAIL . '-ses-verified-emails';
    ...
    public function notificationSettings()
    {
        ...
        $settings = get_option('_formglut_smtp_notify_settings', []);
