...
class Logger extends Model
{
    ...
    public function __construct()
    {
        ...
        $this->table = $this->db->prefix . FORMGLUT_MAIL_DB_PREFIX . 'email_logs';
    }
    ...
    public function get($data)
    {
        ...
        $query = $db->table(FORMGLUT_MAIL_DB_PREFIX . 'email_logs')
            ->limit($perPage)
            ->offset($offset)
            ->orderBy('id', 'DESC');
    ...
    public function add($data)
    {
        try {
            ...
            return $this->getDb()->table(FORMGLUT_MAIL_DB_PREFIX . 'email_logs')
                ->insert($data);
    ...
    public function find($id)
    {
        ...
        $row = $this->getDb()->table(FORMGLUT_MAIL_DB_PREFIX . 'email_logs')
            ->where('id', $id)
            ->first();
    ...
    public function resendEmailFromLog($id, $type = 'retry')
    {
        ...
        try {
            if (!defined('FORMGLUTMAIL_LOG_OFF')) {
                define('FORMGLUTMAIL_LOG_OFF', true);
            }

            $result = formglut_wp_mail(
                $to,
                $email['subject'],
                $email['body'],
                $headers,
