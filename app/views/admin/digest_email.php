...
<head>
    ...
    <title>FormglutSMTP Email Health Report</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" class="body"
    ...
    <tr style="padding: 0; vertical-align: top; text-align: left;">
        <td align="center" valign="top" class="body-inner formglut-smtp"
                        ...
                        <table width="100%">
                            <tr>
                                ...
                                <td style="text-align: right;">
                                    <img src="<?php echo esc_url(formglutMailMix('images/formglutsmtp-white.png')); ?>"
                                         width="164px" alt="Formglut SMTP Logo"
                                        ...
                                        <table width="100%"
                                            ...
                                            <tr style="background-color: #f9f9f9;">
                                                <th style="padding: 8px 10px;"
                                                    align="left"><?php _e('Subject', 'formglut-smtp'); ?></th>
                                                <th style="width:85px; padding: 8px 10px;"><?php _e('Emails Sent', 'formglut-smtp'); ?></th>
                                            </tr>
                                        ...
                                        <table width="100%" cellpadding="20">
                                            <tr>
                                                <td bgcolor="#eeeeee"
                                                    ...
                                                    align="center">
                                                    <h3 style="font-size: 24px; line-height: 30px; font-weight: normal;"><?php _e('Looks like no email has been sent to the time period', 'formglut-smtp'); ?></h3>
                                                    <p>
                                                        <?php _e('If this is unusual you should probably check if your site is broken.', 'formglut-smtp');
                                                        ?>
                                                    </p>
                                                </td>
                                            </tr>
                                ...
                                <td style="padding: 10px 0">
                                    <?php if ($fail['subject_items']): ?>
                                        <table width="100%" style="border: 1px solid #ccd0d4; border-collapse: collapse;">
                                            <tr style="background-color: #f9f9f9;">
                                                <th style="padding: 8px 10px;" align="left"><?php _e('Subject', 'formglut-smtp'); ?></th>
                                                <th style="width:85px; padding: 8px 10px;"><?php _e('Failed Count', 'formglut-smtp'); ?></th>
                                            </tr>
                                        ...
                                        <table width="100%" cellpadding="20">
                                            <tr>
                                                <td bgcolor="#eeeeee"
                                                    ...
                                                    <h3 style="font-size: 24px; line-height: 30px; font-weight: normal;"><?php _e('Awesome! no failures! 🎉', 'formglut-smtp'); ?></h3>
                                                    <p>
                                                        <?php _e('Your email sending health is perfect', 'formglut-smtp');
                                                        ?>
                                                    </p>
                                                </td>
                                            </tr>
                ...
                <tr style="padding: 0; vertical-align: top; text-align: left;">
                    <td valign="middle" class="header" style="word-wrap: break-word; -webkit-hyphens: auto; -moz-hyphens: auto; hyphens: auto; border-collapse: collapse !important; vertical-align: top; mso-table-lspace: 0pt; mso-table-rspace: 0pt; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: white; border: 1px solid #7D3492; background: #7D3492; font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; font-weight: normal; margin: 0; Margin: 0; font-size: 14px; mso-line-height-rule: exactly; line-height: 140%; text-align: left; padding: 10px 20px 10px 20px;">
                        <table width="100%">
                            <tr>
                                <td>
                                    <p style="font-size: 10px; line-height: 12px; color: white;">You received this email because the Email Sending Health Report is enabled in your FormglutSMTP settings. Simply turn it off to stop these emails at <?php echo esc_html($domain_name); ?>.</p>
                                </td>
