<div class="fss_connection_info">
    ...
    <?php if(!$error && empty($stats['Max24HourSend'])): ?>
        <p style="color: red;" class="connection_info_error">
            Looks like you are in sandbox mode. Please apply to Amazon AWS to approve your account. <a href="https://formglutcrm.com/set-up-amazon-ses-with-formglutcrm/#4-moving-out-of-sandbox-mode" target="_blank" rel="nofollow">Read More here.</a>
        </p>
    <?php endif; ?>
