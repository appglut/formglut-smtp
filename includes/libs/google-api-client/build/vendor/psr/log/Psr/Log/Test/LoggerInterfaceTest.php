...
namespace FormglutSmtpLib\Psr\Log\Test;

use FormglutSmtpLib\Psr\Log\LoggerInterface;
use FormglutSmtpLib\Psr\Log\LogLevel;
use FormglutSmtpLib\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('FormglutSmtpLib\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('FormglutSmtpLib\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('FormglutSmtpLib\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
