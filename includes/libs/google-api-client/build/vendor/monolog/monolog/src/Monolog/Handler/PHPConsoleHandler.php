...
use FormglutSmtpLib\PhpConsole\Connector;
use FormglutSmtpLib\PhpConsole\Handler;
use FormglutSmtpLib\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('FormglutSmtpLib\\PhpConsole\\Connector')) {
