 ...
 */
namespace FormglutSmtpLib\Monolog;

use FormglutSmtpLib\Monolog\Handler\HandlerInterface;
use FormglutSmtpLib\Monolog\Handler\StreamHandler;
use FormglutSmtpLib\Psr\Log\LoggerInterface;
use FormglutSmtpLib\Psr\Log\InvalidArgumentException;
use Exception;
/**
 * Monolog log channel
 *
