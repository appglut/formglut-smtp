 ...
 */
namespace FormglutSmtpLib\Google\Auth\HttpHandler;

use Exception;
use FormglutSmtpLib\GuzzleHttp\ClientInterface;
use FormglutSmtpLib\GuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use FormglutSmtpLib\GuzzleHttp\Promise\Promise;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!\class_exists('FormglutSmtpLib\\GuzzleHttp\\Promise\\Promise')) {
