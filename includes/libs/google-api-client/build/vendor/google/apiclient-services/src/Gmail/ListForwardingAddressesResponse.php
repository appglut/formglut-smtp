 ...
 * the License.
 */
namespace FormglutSmtpLib\Google\Service\Gmail;

class ListForwardingAddressesResponse extends \FormglutSmtpLib\Google\Collection
{
...
\class_alias(ListForwardingAddressesResponse::class, 'FormglutSmtpLib\\Google_Service_Gmail_ListForwardingAddressesResponse');
