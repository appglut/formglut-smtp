...
if (\file_exists(__DIR__ . '/../apiclient/src/Google/Client.php') && !\class_exists('FormglutSmtpLib\\Google_Client', \false)) {
    ...
    if (\defined('Google_Client::LIBVER') && \version_compare(Google_Client::LIBVER, '2.7.2', '<=')) {
        $servicesClassMap = ['FormglutSmtpLib\\Google\\Client' => 'Google_Client', 'FormglutSmtpLib\\Google\\Service' => 'Google_Service', 'FormglutSmtpLib\\Google\\Service\\Resource' => 'Google_Service_Resource', 'FormglutSmtpLib\\Google\\Model' => 'Google_Model', 'FormglutSmtpLib\\Google\\Collection' => 'Google_Collection'];
