 ...
 */
namespace FormglutSmtpLib\Google;

use BadMethodCallException;
use DomainException;
use FormglutSmtpLib\Google\AccessToken\Revoke;
use FormglutSmtpLib\Google\AccessToken\Verify;
use FormglutSmtpLib\Google\Auth\ApplicationDefaultCredentials;
use FormglutSmtpLib\Google\Auth\Cache\MemoryCacheItemPool;
use FormglutSmtpLib\Google\Auth\Credentials\ServiceAccountCredentials;
use FormglutSmtpLib\Google\Auth\Credentials\UserRefreshCredentials;
use FormglutSmtpLib\Google\Auth\CredentialsLoader;
use FormglutSmtpLib\Google\Auth\FetchAuthTokenCache;
use FormglutSmtpLib\Google\Auth\HttpHandler\HttpHandlerFactory;
use FormglutSmtpLib\Google\Auth\OAuth2;
use FormglutSmtpLib\Google\AuthHandler\AuthHandlerFactory;
use FormglutSmtpLib\Google\Http\REST;
use FormglutSmtpLib\GuzzleHttp\Client as GuzzleClient;
use FormglutSmtpLib\GuzzleHttp\ClientInterface;
use FormglutSmtpLib\GuzzleHttp\Ring\Client\StreamHandler;
use InvalidArgumentException;
use LogicException;
use FormglutSmtpLib\Monolog\Handler\StreamHandler as MonologStreamHandler;
use FormglutSmtpLib\Monolog\Handler\SyslogHandler as MonologSyslogHandler;
use FormglutSmtpLib\Monolog\Logger;
use FormglutSmtpLib\Psr\Cache\CacheItemPoolInterface;
use FormglutSmtpLib\Psr\Http\Message\RequestInterface;
use FormglutSmtpLib\Psr\Http\Message\ResponseInterface;
use FormglutSmtpLib\Psr\Log\LoggerInterface;
...
class Client
{
    ...
    {
        $guzzleVersion = null;
        if (\defined('\\FormglutSmtpLib\\GuzzleHttp\\ClientInterface::MAJOR_VERSION')) {
            $guzzleVersion = ClientInterface::MAJOR_VERSION;
        } elseif (\defined('\\FormglutSmtpLib\\GuzzleHttp\\ClientInterface::VERSION')) {
