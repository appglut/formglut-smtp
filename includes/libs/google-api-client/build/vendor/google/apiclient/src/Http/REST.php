 ...
 */
namespace FormglutSmtpLib\Google\Http;

use FormglutSmtpLib\Google\Auth\HttpHandler\HttpHandlerFactory;
use FormglutSmtpLib\Google\Service\Exception as GoogleServiceException;
use FormglutSmtpLib\Google\Task\Runner;
use FormglutSmtpLib\GuzzleHttp\ClientInterface;
use FormglutSmtpLib\GuzzleHttp\Exception\RequestException;
use FormglutSmtpLib\GuzzleHttp\Psr7\Response;
...
class REST
{
    ...
    public static function doExecute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
    {
        try {
            ...
            if (\interface_exists('FormglutSmtpLib\\GuzzleHttp\\Message\\ResponseInterface') && $response instanceof \FormglutSmtpLib\GuzzleHttp\Message\ResponseInterface) {
