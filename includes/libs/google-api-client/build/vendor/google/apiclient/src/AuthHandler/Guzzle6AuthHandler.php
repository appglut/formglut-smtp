...
namespace FormglutSmtpLib\Google\AuthHandler;
...
use FormglutSmtpLib\Google\Auth\Middleware\ScopedAccessTokenMiddleware;
use FormglutSmtpLib\Google\Auth\Middleware\SimpleMiddleware;
