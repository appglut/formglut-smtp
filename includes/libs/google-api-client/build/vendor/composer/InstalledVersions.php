 ...
 */
namespace FormglutSmtpLib\Composer;

use FormglutSmtpLib\Composer\Autoload\ClassLoader;
use FormglutSmtpLib\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('FormglutSmtpLib\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
